...
var configPath, dir, e, fs, hache_dir, httpd, httpdBin, httpdConf, httpd_conf_path, path, userConf, which, yaml, _;
...
httpdConf = _.template(fs.readFileSync(httpd_conf_path, {
  encoding: "UTF8"
}));
